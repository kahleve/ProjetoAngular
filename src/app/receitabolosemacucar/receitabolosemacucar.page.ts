...
@Component({
  selector: 'app-receitabolosemacucar',
  templateUrl: './receitabolosemacucar.page.html',
  styleUrls: ['./receitabolosemacucar.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule, RouterLink]
})
export class ReceitabolosemacucarPage {
